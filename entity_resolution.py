...
class EntityResolution:
    ...
    def __init__(
            ...
            entity_index_delimiter_key: Optional[str] = None,
            resolution_result_delimiter_key: Optional[str] = None,
    ...
    def __call__(self, graph: nx.Graph, prompt_variables: Optional[dict[str, Any]] = None) -> EntityResolutionResult:
