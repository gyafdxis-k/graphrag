...
import tiktoken
from graph_prompt import GRAPH_EXTRACTION_PROMPT, CONTINUE_PROMPT, LOOP_PROMPT
from utils import ErrorHandlerFn, perform_variable_replacements, clean_str
...
class GraphExtractor:
    ...
    def __init__(
        ...
        entity_types_key: Optional[str] = None,
