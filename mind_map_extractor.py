...
from utils import ErrorHandlerFn, perform_variable_replacements, num_tokens_from_string
...
class MindMapExtractor:
    ...
    def __call__(
            self, sections: list[str], prompt_variables: Optional[dict[str, Any]] = None
    ) -> MindMapResult:
