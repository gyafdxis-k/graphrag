...
MatchExpr = Union[MatchTextExpr, MatchDenseExpr, MatchSparseExpr, MatchTensorExpr, FusionExpr]
...
class DocStoreConnection(ABC):
    ...
    @abstractmethod
    def search(
        self, selectFields: list[str], highlight: list[str], condition: dict, matchExprs: list[MatchExpr], orderBy: OrderByExpr, offset: int, limit: int, indexNames:
            Union[str, list[str]], knowledgebaseIds: list[str]
